...
return [
    ...
    'fields' => [
        ...
        'filter_logic' => 'Logica filtro',
        'all_conditions' => 'TUTTE LE CONDIZIONI',
        'any_condition' => 'QUALSIASI CONDIZIONE',
        'match_all_description' => 'Ogni condizione deve essere soddisfatta',
        'match_any_description' => 'Almeno una condizione deve essere soddisfatta',
        'runs_always' => 'Esegue sempre',
        ...
        'order' => 'Ordine',
        'execution_pipeline' => 'Pipeline di Esecuzione',
        'security' => 'Sicurezza',
        'endpoint_destination' => 'DESTINAZIONE ENDPOINT',
        'payload_data_mapping' => 'Mappatura Dati Payload',
        'ssl_on' => 'SSL Attivo',
        'ssl_off' => 'SSL Disattivo',
        'auto_generated' => 'Auto-generato',
        'end_of_pipeline' => 'FINE PIPELINE',
        'no_payload_configuration' => 'Nessuna configurazione payload',

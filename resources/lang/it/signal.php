...
return [
    ...
    'helpers' => [
        ...
        'log_configuration' => 'Usa questo tipo di azione per monitorare e registrare eventi specifici. I log vengono creati e salvati automaticamente per questa azione.',
        'log_info' => 'Questa azione creerà una voce di log ogni volta che il trigger viene attivato. Puoi visualizzare tutti i log nella sezione Log di esecuzione. Usa questo per monitorare eventi specifici senza eseguire azioni esterne.',
    ],
    'placeholders' => [

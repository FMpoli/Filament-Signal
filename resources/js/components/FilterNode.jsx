...
const FilterNode = ({
    ...
    return ( <
        ...
        className = "!bg-purple-500 !w-2.5 !h-2.5 !-left-[5px]" / >

        {
            /* Header */ } <
        div className = "bg-purple-500 px-4 py-2 flex items-center justify-between box-border" >
        <
        ...
        /div> <
        div className = "nodrag cursor-pointer text-white/80 hover:text-white flex ml-2 transition-colors"
        onClick = {
            (e) => {
                e.stopPropagation();
                ...
                div className = "flex flex-col gap-2" > {
                    filters.map((filter, index) => ( <
                        ...
                        span className = "text-orange-500 font-bold" > {
                            operatorMap[filter.type] || filter.type
                        } < /span> <
        ...
        className = "!bg-purple-500 !w-2.5 !h-2.5 !-right-[5px]" / >
        <
        /div>
    );
};

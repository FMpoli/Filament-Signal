 ...
 * 
 * Reusable component for selecting nodes.
 * Features:
 * - Tabbed categories (Triggers, Actions, etc.)
 * - Search functionality
 * - Grid layout (2 columns)
 * - Beautiful aesthetic matching user request
 */
const NodePicker = ({
    availableNodes = {},
    onSelectNode,
    ...
    // Set first available category as active if current tab is empty or invalid
    useEffect(() => {
    ...
    return (
        <div className={`bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col ${className}`}>
            {/* Header */}

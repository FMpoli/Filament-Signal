...
const ActionNode = ({
    ...
    return ( <
        div className = {
            ...
            /* Header */ } <
        div className = {
            cn(headerGradient, 'px-4 py-2 flex items-center justify-between box-border')
        } >
        <
        div className = "flex items-center gap-2" > {
            isWebhook ? ( <
                ...
                d = "M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.923 1.042A1 1 0 0113.88 18H6.12a1 1 0 01-.75-1.65L6.5 15H5a2 2 0 01-2-2V5zm11 1H6v8h8V6z"
                clipRule = "evenodd" / >
                <
                /svg>
            )
        ...
        className = {
            cn(handleColor, '!w-2.5 !h-2.5 !-left-[5px]')
        }
        /> <
        /div>
    );

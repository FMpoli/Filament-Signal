                                ...
                                ->schema(function (Get $get): array {
                                    ...
                                    foreach ($analysis['relations'] as $relation) {
                                        ...
                                        foreach ($fieldOptions as $fieldKey => $label) {
                                            ...
                                            // Gestisce vari formati: "unit.brand.name", "Unit.brand.name", "unit - brand - name", ecc.
                                            $formattedLabel = $label;

                                            // Se l'etichetta contiene punti, formattala con frecce

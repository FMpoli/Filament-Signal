...
namespace Voodflow\Voodflow\Nodes\WebhookNode;
 ...
 * 
 * This is a PROOF OF CONCEPT for the new self-contained node architecture.
 */
class WebhookNode implements NodeInterface
{
    public static function type(): string
    {
        return 'voodflow_webhook';
    }
